...
from forum.views import show_forum, show_forum_by_id, create_forum, delete_forum, delete_balasan, edit_balasan, edit_forum, balas_ajax, show_balasan
...
urlpatterns = [
    ...
    path('<uuid:id_forum>/balas_ajax', balas_ajax, name='balas_ajax'),
