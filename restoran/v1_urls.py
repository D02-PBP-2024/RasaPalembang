...
urlpatterns = [
    ...
    path(
        "user/<str:username>/", restoran_by_user, name="restoran_by_user"
    ),  # should not exist, wrong implementation
    path(
        "<uuid:id_restoran>/makanan/", makanan_by_restoran, name="makanan_by_restoran"
    ),
    path(
        "<uuid:id_restoran>/minuman/", minuman_by_restoran, name="minuman_by_restoran"
    ),
    path(
        "<uuid:id_restoran>/favorit/", favorit_by_restoran, name="favorit_by_restoran"
    ),
